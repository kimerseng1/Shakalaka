...
async function PUT(req, { params }) {
    try {
        const { id } = params; // id is now available correctly
        if (!id) throw new Error("Movie ID is missing");
        const data = await req.json();
        const updatedMovie = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$controller$2f$movie$2e$contoller$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["movieController"].updateMovie(Number(id), data);
...
async function DELETE(req, { params }) {
    try {
        const { id } = params;
        if (!id) throw new Error("Movie ID is missing");
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$controller$2f$movie$2e$contoller$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["movieController"].deleteMovie(Number(id));
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__214bbf71._.js.map