...
async function getMovies() {
    try {
        // Use a raw SQL query on the pool (e.g. pg or mysql) since Pool has no `movies` property.
        const result = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["pool"].query('SELECT * FROM movies ORDER BY "createdAt" DESC');
        const movies = result?.rows ?? result?.[0] ?? [];
        return movies.length > 0 ? movies : __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$constants$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["INITIAL_MOVIES"];
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__29ebc15a._.js.map