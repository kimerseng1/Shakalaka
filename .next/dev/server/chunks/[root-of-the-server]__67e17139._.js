...
async function GET() {
    try {
        const movies = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].movie.findMany({
            orderBy: {
                createdAt: "desc"
            }
        });
...
async function POST(request) {
    try {
        ...
        const movie = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].movie.create({
            data: {
                title: body.title,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__67e17139._.js.map